CLASS cl_xco_cp_me_fld_text_attr_f DEFINITION PUBLIC FINAL CREATE PRIVATE.
  PUBLIC SECTION.
    DATA:
      endusertext_label              TYPE REF TO cl_xco_me_fld_text_attribute READ-ONLY,
      endusertext_quickinfo          TYPE REF TO cl_xco_me_fld_text_attribute READ-ONLY,

      consumption_dynamiclabel_label TYPE REF TO cl_xco_me_fld_text_attribute READ-ONLY.
