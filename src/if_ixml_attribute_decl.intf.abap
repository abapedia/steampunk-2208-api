...
INTERFACE if_ixml_attribute_decl
  ...
  CONSTANTS co_cdata TYPE i VALUE 1. "#EC NOTEXT
  CONSTANTS co_default_value TYPE i VALUE 1. "#EC NOTEXT
  CONSTANTS co_entities TYPE i VALUE 6. "#EC NOTEXT
  CONSTANTS co_entity TYPE i VALUE 5. "#EC NOTEXT
  CONSTANTS co_enumeration TYPE i VALUE 10. "#EC NOTEXT
  CONSTANTS co_fixed TYPE i VALUE 3. "#EC NOTEXT
  CONSTANTS co_id TYPE i VALUE 2. "#EC NOTEXT
  CONSTANTS co_idref TYPE i VALUE 3. "#EC NOTEXT
  CONSTANTS co_idrefs TYPE i VALUE 4. "#EC NOTEXT
  CONSTANTS co_implied TYPE i VALUE 1. "#EC NOTEXT
  CONSTANTS co_nmtoken TYPE i VALUE 7. "#EC NOTEXT
  CONSTANTS co_nmtokens TYPE i VALUE 8. "#EC NOTEXT
  CONSTANTS co_notation TYPE i VALUE 9. "#EC NOTEXT
  CONSTANTS co_required TYPE i VALUE 2. "#EC NOTEXT

  METHODS add_enum_value
    IMPORTING
      !value TYPE string
    RETURNING
      VALUE(rval) TYPE abap_bool.
  METHODS allows_enum_value
    IMPORTING
      !value TYPE string
    RETURNING
      VALUE(rval) TYPE abap_bool.
  METHODS get_attr_default
    RETURNING
      VALUE(rval) TYPE i.
  METHODS get_default_value
    RETURNING
      VALUE(rval) TYPE string.
  METHODS get_enum_value
    IMPORTING
      !index TYPE i
    RETURNING
      VALUE(rval) TYPE string.
  METHODS get_value_type
    RETURNING
      VALUE(rval) TYPE i.
  METHODS remove_enum_value
    IMPORTING
      !value TYPE string
    RETURNING
      VALUE(rval) TYPE abap_bool.
  METHODS set_attr_default
    IMPORTING
      !attr_default TYPE i.
  METHODS set_default_value
    IMPORTING
      !default_value TYPE string.
  METHODS set_value_type
    IMPORTING
      !value_type TYPE i.
ENDINTERFACE.