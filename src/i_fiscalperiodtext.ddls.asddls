...
@AbapCatalog.sqlViewName: 'IFIFISCPERTXT'
//@AbapCatalog.compiler.compareFilter: true
...
define view I_FiscalPeriodText as select from t009c inner join finsc_period on  periv = finsc_period.fiscal_year_variant
