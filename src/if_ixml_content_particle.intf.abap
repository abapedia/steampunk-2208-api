...
INTERFACE if_ixml_content_particle
  ...
  CONSTANTS co_choice TYPE i VALUE 1. "#EC NOTEXT
  CONSTANTS co_one TYPE i VALUE 1. "#EC NOTEXT
  CONSTANTS co_one_or_more TYPE i VALUE 4. "#EC NOTEXT
  CONSTANTS co_sequence TYPE i VALUE 2. "#EC NOTEXT
  CONSTANTS co_zero_or_more TYPE i VALUE 3. "#EC NOTEXT
  CONSTANTS co_zero_or_one TYPE i VALUE 2. "#EC NOTEXT

  METHODS add_content_particle
    IMPORTING
      !content_particle TYPE REF TO if_ixml_content_particle.
  METHODS get_content_particle
    IMPORTING
      !index TYPE i
    RETURNING
      VALUE(rval) TYPE REF TO if_ixml_content_particle.
  METHODS get_grouping
    RETURNING
      VALUE(rval) TYPE i.
  METHODS get_occurrence
    RETURNING
      VALUE(rval) TYPE i.
  METHODS num_content_particles
    RETURNING
      VALUE(rval) TYPE i.
  METHODS set_grouping
    IMPORTING
      !grouping TYPE i.
