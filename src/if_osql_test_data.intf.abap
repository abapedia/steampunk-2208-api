INTERFACE if_osql_test_data
  ...
  METHODS:
    ...
    for_parameters
      IMPORTING
        i_parameter_values TYPE if_osql_param_values_config=>ty_parameter_value_pairs
      RETURNING
        VALUE(r_test_data) TYPE REF TO if_osql_test_data,
    set_client
      IMPORTING
        client             TYPE mandt
      RETURNING
    ...
    set_null_values
      IMPORTING
        i_null_values      TYPE  if_osql_null_values_config=>ty_element_names
      RETURNING
        VALUE(r_test_data) TYPE REF TO if_osql_test_data,
    ...
    set_null_values_config
      IMPORTING
        i_config           TYPE REF TO if_osql_null_values_config
      RETURNING
        VALUE(r_test_data) TYPE REF TO if_osql_test_data,
    ...
    set_parameter_values_config
      IMPORTING
        i_config TYPE REF TO if_osql_param_values_config.
